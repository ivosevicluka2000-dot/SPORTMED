...
import RecoveryEstimator from "@/components/tools/RecoveryEstimator";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "tools.recoveryEstimator" });
...
export default async function RecoveryEstimatorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
